...
% tutaj dudzin mówił że trzeba dokładnie opisać jak mają się te wszystkie accuracy do tego że to jest wieloklasowe.

% jak to ktoś już zrobi to trzeba potem sprawdzić czy wyniki wszystkich tych metod mają je wszystkie i czy dobrze je interpretują
...
% EXTRA LABELS
% ------------------------
\node[align=center] at (0, -1.0) {16 cech};
...
Dla każdej z siedmiu odmian fasoli utworzono po dwie sztuczne obserwacje. Najpierw dla każdej klasy i każdej zmiennej objaśniającej wyznaczono średnią oraz odchylenie standardowe na podstawie obserwacji należących do danej klasy w zbiorze uczącym. Następnie wartości sztucznych cech losowano z rozkładu normalnego:
